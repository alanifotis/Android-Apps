...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class KotlinxSerializationLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>kotlinxJson</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class Okhttp3LibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>okhttp3Bom</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getBom() {
            return create("okhttp3.bom");
        }
    ...
    public static class RetrofitLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>main</b> with <b>com.squareup.retrofit2:retrofit</b> coordinates and
         * with version reference <b>retrofitVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getMain() {
            return create("retrofit.main");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>kotlinxJson</b> with value <b>1.7.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKotlinxJson() { return getVersion("kotlinxJson"); }
        ...
        /**
         * Version alias <b>lifecycleViewmodel</b> with value <b>2.8.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>okhttp3Bom</b> with value <b>4.12.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getOkhttp3Bom() { return getVersion("okhttp3Bom"); }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final DevtoolPluginAccessors paccForDevtoolPluginAccessors = new DevtoolPluginAccessors(providers, config);
        ...
        /**
         * Group of plugins at <b>plugins.devtool</b>
         */
        public DevtoolPluginAccessors getDevtool() {
            return paccForDevtoolPluginAccessors;
        }
    ...
    public static class DevtoolPluginAccessors extends PluginFactory {

        public DevtoolPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>devtool.ksp</b> with plugin id <b>com.google.devtools.ksp</b> and
         * with version <b>2.0.20-1.0.24</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getKsp() { return createPlugin("devtool.ksp"); }
    ...
    public static class KotlinPluginAccessors extends PluginFactory {
        ...
        /**
         * Group of plugins at <b>plugins.kotlin.serialization</b>
         */
    ...
    public static class KotlinSerializationPluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>kotlin.serialization.plugin</b> with plugin id <b>org.jetbrains.kotlin.plugin.serialization</b> and
         * with version reference <b>kotlin</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
